                       ...
                       gdf_context* options)
{
  ...
  { 
    case GDF_FIRST:
      {
        gdf_error_code = group_by_sort::gdf_group_by_sort<first_op>(num_key_columns,
                                                   in_key_columns,
                                                   in_aggregation_columns[0],
                                                   out_key_columns,
                                                   out_aggregation_columns[0],
    ...
    case GDF_COUNT_DISTINCT:
      {
        gdf_error_code = group_by_sort::gdf_group_by_sort<count_op_distinct>(num_key_columns,
                                                   in_key_columns,
                                                   in_aggregation_columns[0],
                                                   out_key_columns,
                                                   out_aggregation_columns[0],
